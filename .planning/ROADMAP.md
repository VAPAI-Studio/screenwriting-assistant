...
- [ ] **Phase 26: AI Shotlist Generation Service** - Backend service that reads script content and generates a complete shotlist with smart merge
...
**Plans:** 2 plans
Plans:
- [ ] 26-01-PLAN.md — Schema foundation: delta migration, ORM + schema updates for user_modified/ai_generated, update endpoint flag
- [ ] 26-02-PLAN.md — ShotlistGenerationService: AI context builder, structured output, smart merge, generate endpoint + tests
...
| 26. AI Shotlist Generation Service | v3.1 | 0/2 | Not started | - |
