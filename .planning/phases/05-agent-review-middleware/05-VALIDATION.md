...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 05-01-01 | 01 | 1 | REVW-01 | unit | `pytest app/tests/test_agent_review_middleware.py::test_review_returns_refined_output -x` | ❌ W0 | ⬜ pending |
| 05-02-01 | 02 | 1 | REVW-02 | unit | `pytest app/tests/test_agent_review_middleware.py::test_parallel_fanout_uses_session_factory -x` | ❌ W0 | ⬜ pending |
| 05-03-01 | 03 | 1 | REVW-03 | unit | `pytest app/tests/test_agent_review_middleware.py::test_merge_preserves_wizard_schema -x` | ❌ W0 | ⬜ pending |
| 05-04-01 | 04 | 1 | REVW-04 | unit | `pytest app/tests/test_agent_review_middleware.py::test_zero_agents_passthrough -x` | ❌ W0 | ⬜ pending |
| 05-01-02 | 01 | 1 | REVW-01 | unit | `pytest app/tests/test_agent_review_middleware.py::test_agents_consulted_metadata -x` | ❌ W0 | ⬜ pending |
