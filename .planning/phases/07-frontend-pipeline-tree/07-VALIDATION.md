...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 07-01-01 | 01 | 1 | TREE-01 | build | `cd frontend && npm run build` | ✅ | ⬜ pending |
| 07-02-01 | 02 | 1 | TREE-01 | build + manual | `cd frontend && npm run build` | ✅ | ⬜ pending |
| 07-03-01 | 03 | 1 | TREE-02 | build + manual | `cd frontend && npm run build` | ✅ | ⬜ pending |
| 07-04-01 | 04 | 1 | TREE-01 | build + manual | `cd frontend && npm run build` | ✅ | ⬜ pending |
| 07-05-01 | 05 | 2 | TREE-03 | build + manual | `cd frontend && npm run build` | ✅ | ⬜ pending |
